...
<%
	...
	List<Product> products = ProductDbUtil.getProducts(5);
%>
<!DOCTYPE html>
<html>
<head>
...
<br><br>
	...
	<section class="products" id="products">
        <div class="heading ms-2"><h1>All Beverages<br><span>Products</span></h1></div>
        		...
        		if(!products.isEmpty()){
        			for(Product p:products){ %>
        				<div class="box">
	                        ...
	                        <a href="cart?id=<%= p.getId() %>&page=beverages" class="btn"><i class='bx bx-cart'></i></a>          
                    	</div>
        			<%}
        		}
        	%>
