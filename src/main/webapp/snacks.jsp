...
<%
	...
	List<Product> products = ProductDbUtil.getProducts(6);
%>
<!DOCTYPE html>
<html>
<head>
...
<br><br>
	...
	<section class="products" id="products">
        <div class="heading ms-2"><h1>All Snacks<br><span>Products</span></h1></div>
        		...
        		if(!products.isEmpty()){
        			for(Product p:products){ %>
        				<div class="box">
	                        ...
	                        <a href="cart?id=<%= p.getId() %>&page=snacks" class="btn"><i class='bx bx-cart'></i></a>          
                    	</div>
        			<%}
        		}
        	%>
