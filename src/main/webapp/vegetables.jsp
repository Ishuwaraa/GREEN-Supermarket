...
<%
	...
	List<Product> products = ProductDbUtil.getProducts(1);
%>
<!DOCTYPE html>
<html>
<head>
...
<br><br>
	...
	<section class="products" id="products">
        <div class="heading ms-2"><h1>All Vegetables<br><span>Products</span></h1></div>
