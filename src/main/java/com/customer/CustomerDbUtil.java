...
public class CustomerDbUtil {
	...
	public static Customer userLogin(String email, String password) {
		...
		try {
			...
			String sql = "select * from greensuperdb.customer where email = '"+email+"' and password = '"+password+"' ";
	...
	public static boolean insertCustomer(String name, String email, String phone, String username, String password) {
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "insert into greensuperdb.customer values (0, '"+name+"', '"+email+"', '"+phone+"', '"+username+"', '"+password+"') ";
	...
	public static Customer userUpdate(String id, String name, String email, String phone, String username) {
		...
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "update greensuperdb.customer set customer_name = '"+name+"', email = '"+email+"', phone = '"+phone+"', username = '"+username+"' where customer_id = '"+id+"' ";
	...
	public static boolean confirmPass(String id, String curPassword) {	
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from greensuperdb.customer where password = '"+curPassword+"' and customer_id = '"+id+"'";
			rs = stmt.executeQuery(sql);
	...
	public static Customer userUpdatePass(String id, String password) {
		...
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "update greensuperdb.customer set password = '"+password+"' where customer_id = '"+id+"' ";
			int affected = stmt.executeUpdate(sql);
	...
	public static boolean deleteCustomer(int id) {	
		...
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "delete from greensuperdb.customer where customer_id = '"+id+"' ";
	...
	public static List<Customer> getCustomerDetails(String id){
		...
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "select * from greensuperdb.customer where customer_id = '"+convertedId+"' ";
			rs = stmt.executeQuery(sql);
	...
	public static boolean feedback(String name, String email, String phone, String message) {
		try {
			con = DbConnect.getConnection();
			stmt = con.createStatement();
			String sql = "insert into greensuperdb.feedback values (0, '"+name+"', '"+email+"', '"+phone+"', '"+message+"')";
			int affected = stmt.executeUpdate(sql);
			if(affected > 0) {
				isSuccess = true;
			}else {
